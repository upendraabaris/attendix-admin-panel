...
//   const isRuleBased = RULE_BASED_TYPES.includes(formData.leave_type);
...
//     try {
//       setSubmitting(true);
//       const res = await api.put(`/admin/leave-policy/${policy.id}`, payload);
//       toast.success("Leave policy updated");

//       // Backend se updated data aaye toh use karo, warna local formData se banao
//       const updatedPolicy = res?.data?.data ?? { ...policy, ...payload };
...
//             {/* Rule-based config (earned + casual) */}
//             {isRuleBased && (
//               <div className="rounded-lg border border-blue-100 bg-blue-50 p-4 space-y-4">
//                 <div className="flex items-center gap-2 mb-1">
//                   <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
//   // ── Drawer save: locally update state, GET call nahi ──
...
//                     <TableCell>
//                       {RULE_BASED_TYPES.includes(policy.leave_type)
//                         ? (policy.earned_days_required != null && policy.earned_leave_award != null)
//                           ? `${policy.earned_days_required} days → ${policy.earned_leave_award} leave`
//                           : "-"
//                         : "-"}
//                     </TableCell>

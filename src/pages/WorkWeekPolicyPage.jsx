                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        At midnight, team members with no clock-in for the completed day get an Unpaid leave request with Absent as the reason. Weekly offs and holidays are skipped.
                      </p>
                    </div>
